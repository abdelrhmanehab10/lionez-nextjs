...
export const tv_box = [
  "رامات 4 جيجا",
  "مساحه تخزينيه 32 جيجا",
  "مدخل HDMI",
  "مدخل ايثرنت لتوصيل كابل انترنت",
  "واي فاي",
  "الجهاز + اشتراك VIP+ اشتراك GOLD  بمبلغ 350 درهم بدل 400",
  "الجهاز + اشتراك VIP بمبلغ 300 درهم بدل 350",
  "الجهاز + اشتراك GOLD  بمبلغ 250 درهم بدل 300 ",
  "مصاريف الشحن ٣٠ درهم",
  "متوفر داخل الامارات فقط في الوقت الحالي",
];
